...
if(!isset($_SESSION['COUNTER'])){
    $_SESSION['COUNTER']= 1;
    $createOrder = "insert into orders (order_id,user_id) VALUES ({$_SESSION['COUNTER']},'{$_SESSION['ID']}');";
...
$sql = "insert into orderdetail (order_id,menu_code,order_quantity,order_price) values ({$_SESSION['COUNTER']},'{$row['menu_code']}',1,'{$row['menu_price']}')";
